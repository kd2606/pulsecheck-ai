...
export default function SkinScanPage() {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            const result = await analyzeSkinScan({ imageBase64: imageData, itchingLevel, spreadRate, recentChanges });
            setResults(result);
            if (!result) return;
            ...
            await saveHealthRecord(user?.uid, {
                ...
                details: {
                    features: result.visualFeatures?.map(f => f.feature) || [],
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex gap-2">
                                <Button variant="outline" onClick={startCamera} disabled={showCamera} className="w-full">
